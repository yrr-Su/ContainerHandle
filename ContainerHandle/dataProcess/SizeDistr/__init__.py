...
class SizeDistr(_writter):
	...
	def merge_SMPS_APS_v4(self, df_smps, df_aps, df_pm25, aps_unit='um',
						  smps_overlap_lowbound=500, aps_fit_highbound=1000, dndsdv_alg=True, times_range=(0.8, 1.25, .05)):
		from ._merge_v4 import merge_SMPS_APS
		
		out = merge_SMPS_APS(df_smps, df_aps, df_pm25, aps_unit, smps_overlap_lowbound, aps_fit_highbound, dndsdv_alg, times_range)
