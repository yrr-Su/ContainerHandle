...
def _basic(_df_voc):
	...
	_voc_clasfy = {
					'alkane_total' : 	[ 'Isopentane', 'n-Butane', '2-Methylhexane', 'Cyclopentane', '3-Methylpentane', '2,3-Dimethylbutane', 
										  '2-Methylheptane', 'n-Nonane', 'Methylcyclohexane', '2,4-Dimethylpentane', '2-Methylpentane', 'n-Decane', 
										  'n-Heptane', 'Cyclohexane', 'n-Octane', 'Isobutane', '2,2-Dimethylbutane', 'Methylcyclopentane', 'n-Hexane', 
					...
					'aromatic_total' :	[ 'o-Ethyltoluene', '1,3,5-Trimethylbenzene', 'Ethylbenzene', 'm,p-Xylene', 'n-Propylbenzene', 
										  'Benzene', 'Toluene', '1.2.4-TMB', 'Styrene', 'p-Ethyltoluene', 'o-Xylene', 'm-Diethylbenzene', 
										  '1.2.3-TMB', 'Isopropylbenzene', 'm-Ethyltoluene', '2-Ethyltoluene', '1.3.5-TMB', 'Iso-Propylbenzene', 
										  '3.4-Ethyltoluene', 'p-Diethylbenzene', '1,2,4-Trimethylbenzene', 'm.p-Xylene', '1,2,3-Trimethylbenzene' ],
