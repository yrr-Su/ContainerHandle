...
class reader(_reader):
	...
	def _raw_reader(self,_file):
		...
		_keys = ['Ethane', 'Propane', 'Isobutane', 'n-Butane', 'Cyclopentane', 'Isopentane', 'n-Pentane', '2,2-Dimethylbutane', '2,3-Dimethylbutane',
				 ...
				 '1,2,3-Trimethylbenzene', 'm-Diethylbenzene', 'p-Diethylbenzene']
		...
		return _df[_keys].loc[_df.index.dropna()].loc[~_df.index.duplicated()]